...
def logo():
    ...
    print(Panel("[bold black]【[white]•[bold black]】[bold yellow] DEVELOPER   [white]➤ [dark_olive_green2]MOHAMMAD ALAMIN \n[bold black]【[white]•[bold black]】[bold yellow] GITHUB      [white]➤ [dark_olive_green2]ALAMIN-2K07 \n[bold black]【[white]•[bold black]】[bold yellow] VERSION     [white]➤ [dark_olive_green2]2K07\n[bold black]【[white]•[bold black]】[bold yellow] TELEGRAM    [white]➤ [dark_olive_green2]t.me/ALAMIN2K07\n[bold black]【[white]•[bold black]】[bold yellow] TOOL'S NAME [white]➤ [bold purple reverse] TERMUX BESIC SETUP ", style="bold bright_black"))
...
def menu():
    ...
    elif option in ['2','02','B','b']:clear();os.system('rm -rf BANNER && cd && git clone https://github.com/ALAMIN-2K07/BANNER.git && cd BANNER && python2 banner.py')
...
def admin():
    ...
    option = Console().input("[bold bright_black]   ╰─>[white] ")
    if option in ['1','01','A','a']:os.system('xdg-open https://www.facebook.com/ALAMIN2K07');menu()
    elif option in ['2','02','B','b']:os.system('xdg-open https://wa.me/+8801300504976');menu()
    elif option in ['3','03','C','c']:os.system('xdg-open https://t.me/ALAMIN2K07');menu()
    elif option in ['4','04','D','d']:os.system('xdg-open https://github.com/ALAMIN-2K07');menu()
...
def full_setup():
    ...
    print(Panel("\t[bold black]【[white]•[bold black]】[sea_green2]INST
